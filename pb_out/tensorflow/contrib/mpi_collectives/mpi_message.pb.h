...
#ifndef PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fmpi_5fcollectives_2fmpi_5fmessage_2eproto
#define PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fmpi_5fcollectives_2fmpi_5fmessage_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_tensorflow_2fcontrib_2fmpi_5fcollectives_2fmpi_5fmessage_2eproto 
...
namespace google {
namespace protobuf {
template<> ::tensorflow::contrib::mpi_collectives::MPIRequest* Arena::CreateMaybeMessage<::tensorflow::contrib::mpi_collectives::MPIRequest>(Arena*);
template<> ::tensorflow::contrib::mpi_collectives::MPIResponse* Arena::CreateMaybeMessage<::tensorflow::contrib::mpi_collectives::MPIResponse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
namespace contrib {
...
class MPIRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.contrib.mpi_collectives.MPIRequest) */ {
 public:
  MPIRequest();
  virtual ~MPIRequest();
  ...
  ::tensorflow::contrib::mpi_collectives::MPIRequest_RequestType request_type() const;
  void set_request_type(::tensorflow::contrib::mpi_collectives::MPIRequest_RequestType value);

  // .tensorflow.DataType tensor_type = 3;
  void clear_tensor_type();
  static const int kTensorTypeFieldNumber = 3;
  ::tensorflow::DataType tensor_type() const;
  void set_tensor_type(::tensorflow::DataType value);
 ...
 private:
  ...
  friend struct ::protobuf_tensorflow_2fcontrib_2fmpi_5fcollectives_2fmpi_5fmessage_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class MPIResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.contrib.mpi_collectives.MPIResponse) */ {
 public:
  MPIResponse();
  virtual ~MPIResponse();
  ...
  ::tensorflow::contrib::mpi_collectives::MPIResponse_ResponseType response_type() const;
  void set_response_type(::tensorflow::contrib::mpi_collectives::MPIResponse_ResponseType value);
...
inline ::google::protobuf::int32 MPIRequest::request_rank() const {
  // @@protoc_insertion_point(field_get:tensorflow.contrib.mpi_collectives.MPIRequest.request_rank)
  return request_rank_;
}
inline void MPIRequest::set_request_rank(::google::protobuf::int32 value) {
  
  request_rank_ = value;
  // @@protoc_insertion_point(field_set:tensorflow.contrib.mpi_collectives.MPIRequest.request_rank)
}
...
inline ::tensorflow::contrib::mpi_collectives::MPIRequest_RequestType MPIRequest::request_type() const {
  // @@protoc_insertion_point(field_get:tensorflow.contrib.mpi_collectives.MPIRequest.request_type)
  return static_cast< ::tensorflow::contrib::mpi_collectives::MPIRequest_RequestType >(request_type_);
}
inline void MPIRequest::set_request_type(::tensorflow::contrib::mpi_collectives::MPIRequest_RequestType value) {
  
  request_type_ = value;
  // @@protoc_insertion_point(field_set:tensorflow.contrib.mpi_collectives.MPIRequest.request_type)
}
...
inline ::tensorflow::DataType MPIRequest::tensor_type() const {
  // @@protoc_insertion_point(field_get:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_type)
  return static_cast< ::tensorflow::DataType >(tensor_type_);
}
inline void MPIRequest::set_tensor_type(::tensorflow::DataType value) {
  
  tensor_type_ = value;
  // @@protoc_insertion_point(field_set:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_type)
}
...
inline const ::std::string& MPIRequest::tensor_name() const {
  // @@protoc_insertion_point(field_get:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_name)
...
inline void MPIRequest::set_tensor_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_name)
}
#if LANG_CXX11
inline void MPIRequest::set_tensor_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_name)
}
#endif
inline void MPIRequest::set_tensor_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_name)
}
inline void MPIRequest::set_tensor_name(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_name)
}
inline ::std::string* MPIRequest::mutable_tensor_name() {
  
  // @@protoc_insertion_point(field_mutable:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_name)
...
inline ::std::string* MPIRequest::release_tensor_name() {
  // @@protoc_insertion_point(field_release:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_name)
...
inline void MPIRequest::set_allocated_tensor_name(::std::string* tensor_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_name)
}
...
inline const ::tensorflow::TensorShapeProto& MPIRequest::_internal_tensor_shape() const {
  return *tensor_shape_;
}
inline const ::tensorflow::TensorShapeProto& MPIRequest::tensor_shape() const {
  const ::tensorflow::TensorShapeProto* p = tensor_shape_;
  // @@protoc_insertion_point(field_get:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_shape)
  return p != NULL ? *p : *reinterpret_cast<const ::tensorflow::TensorShapeProto*>(
      &::tensorflow::_TensorShapeProto_default_instance_);
}
inline ::tensorflow::TensorShapeProto* MPIRequest::release_tensor_shape() {
  // @@protoc_insertion_point(field_release:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_shape)
  
  ::tensorflow::TensorShapeProto* temp = tensor_shape_;
  tensor_shape_ = NULL;
  return temp;
}
inline ::tensorflow::TensorShapeProto* MPIRequest::mutable_tensor_shape() {
  
  if (tensor_shape_ == NULL) {
    auto* p = CreateMaybeMessage<::tensorflow::TensorShapeProto>(GetArenaNoVirtual());
    tensor_shape_ = p;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_shape)
  return tensor_shape_;
}
inline void MPIRequest::set_allocated_tensor_shape(::tensorflow::TensorShapeProto* tensor_shape) {
  ...
  // @@protoc_insertion_point(field_set_allocated:tensorflow.contrib.mpi_collectives.MPIRequest.tensor_shape)
}
...
inline ::tensorflow::contrib::mpi_collectives::MPIResponse_ResponseType MPIResponse::response_type() const {
  // @@protoc_insertion_point(field_get:tensorflow.contrib.mpi_collectives.MPIResponse.response_type)
  return static_cast< ::tensorflow::contrib::mpi_collectives::MPIResponse_ResponseType >(response_type_);
}
inline void MPIResponse::set_response_type(::tensorflow::contrib::mpi_collectives::MPIResponse_ResponseType value) {
  
  response_type_ = value;
  // @@protoc_insertion_point(field_set:tensorflow.contrib.mpi_collectives.MPIResponse.response_type)
}
...
inline const ::std::string& MPIResponse::tensor_name() const {
  // @@protoc_insertion_point(field_get:tensorflow.contrib.mpi_collectives.MPIResponse.tensor_name)
  return tensor_name_.GetNoArena();
}
inline void MPIResponse::set_tensor_name(const ::std::string& value) {
  
  tensor_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:tensorflow.contrib.mpi_collectives.MPIResponse.tensor_name)
}
#if LANG_CXX11
inline void MPIResponse::set_tensor_name(::std::string&& value) {
  ...
  tensor_name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:tensorflow.contrib.mpi_collectives.MPIResponse.tensor_name)
}
#endif
inline void MPIResponse::set_tensor_name(const char* value) {
  ...
  tensor_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:tensorflow.contrib.mpi_collectives.MPIResponse.tensor_name)
}
inline void MPIResponse::set_tensor_name(const char* value, size_t size) {
  
  tensor_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:tensorflow.contrib.mpi_collectives.MPIResponse.tensor_name)
}
inline ::std::string* MPIResponse::mutable_tensor_name() {
  
  // @@protoc_insertion_point(field_mutable:tensorflow.contrib.mpi_collectives.MPIResponse.tensor_name)
  return tensor_name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MPIResponse::release_tensor_name() {
  // @@protoc_insertion_point(field_release:tensorflow.contrib.mpi_collectives.MPIResponse.tensor_name)
...
inline void MPIResponse::set_allocated_tensor_name(::std::string* tensor_name) {
  ...
  tensor_name_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), tensor_name);
  // @@protoc_insertion_point(field_set_allocated:tensorflow.contrib.mpi_collectives.MPIResponse.tensor_name)
}
...
inline const ::std::string& MPIResponse::error_message() const {
  // @@protoc_insertion_point(field_get:tensorflow.contrib.mpi_collectives.MPIResponse.error_message)
  return error_message_.GetNoArena();
}
inline void MPIResponse::set_error_message(const ::std::string& value) {
  
  error_message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:tensorflow.contrib.mpi_collectives.MPIResponse.error_message)
}
#if LANG_CXX11
inline void MPIResponse::set_error_message(::std::string&& value) {
  ...
  error_message_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:tensorflow.contrib.mpi_collectives.MPIResponse.error_message)
}
#endif
inline void MPIResponse::set_error_message(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:tensorflow.contrib.mpi_collectives.MPIResponse.error_message)
}
inline void MPIResponse::set_error_message(const char* value, size_t size) {
  
  error_message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:tensorflow.contrib.mpi_collectives.MPIResponse.error_message)
}
inline ::std::string* MPIResponse::mutable_error_message() {
  
  // @@protoc_insertion_point(field_mutable:tensorflow.contrib.mpi_collectives.MPIResponse.error_message)
  return error_message_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MPIResponse::release_error_message() {
  // @@protoc_insertion_point(field_release:tensorflow.contrib.mpi_collectives.MPIResponse.error_message)
...
inline void MPIResponse::set_allocated_error_message(::std::string* error_message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:tensorflow.contrib.mpi_collectives.MPIResponse.error_message)
}
...
template <> struct is_proto_enum< ::tensorflow::contrib::mpi_collectives::MPIRequest_RequestType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tensorflow::contrib::mpi_collectives::MPIRequest_RequestType>() {
  return ::tensorflow::contrib::mpi_collectives::MPIRequest_RequestType_descriptor();
}
template <> struct is_proto_enum< ::tensorflow::contrib::mpi_collectives::MPIResponse_ResponseType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tensorflow::contrib::mpi_collectives::MPIResponse_ResponseType>() {
  return ::tensorflow::contrib::mpi_collectives::MPIResponse_ResponseType_descriptor();
}
...
#endif  // PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fmpi_5fcollectives_2fmpi_5fmessage_2eproto
