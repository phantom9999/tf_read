...
#ifndef PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fverbs_2fverbs_5fservice_2eproto
#define PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fverbs_2fverbs_5fservice_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_tensorflow_2fcontrib_2fverbs_2fverbs_5fservice_2eproto 
...
namespace google {
namespace protobuf {
template<> ::tensorflow::Channel* Arena::CreateMaybeMessage<::tensorflow::Channel>(Arena*);
template<> ::tensorflow::ErrorStatusProto* Arena::CreateMaybeMessage<::tensorflow::ErrorStatusProto>(Arena*);
template<> ::tensorflow::GetRemoteAddressRequest* Arena::CreateMaybeMessage<::tensorflow::GetRemoteAddressRequest>(Arena*);
template<> ::tensorflow::GetRemoteAddressResponse* Arena::CreateMaybeMessage<::tensorflow::GetRemoteAddressResponse>(Arena*);
template<> ::tensorflow::MemoryRegion* Arena::CreateMaybeMessage<::tensorflow::MemoryRegion>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class GetRemoteAddressRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.GetRemoteAddressRequest) */ {
 public:
  ...
  private:
  const ::tensorflow::Channel& _internal_channel() const;
  public:
...
inline const ::tensorflow::Channel& GetRemoteAddressRequest::_internal_channel() const {
  return *channel_;
}
...
inline ::tensorflow::Channel* GetRemoteAddressRequest::mutable_channel() {
  ...
  if (channel_ == NULL) {
    auto* p = CreateMaybeMessage<::tensorflow::Channel>(GetArenaNoVirtual());
    channel_ = p;
  }
...
inline const ::tensorflow::Channel& GetRemoteAddressResponse::_internal_channel() const {
  return *channel_;
}
...
#endif  // PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fverbs_2fverbs_5fservice_2eproto
