...
#ifndef PROTOBUF_INCLUDED_tensorflow_2fpython_2ftraining_2fcheckpoint_5fstate_2eproto
#define PROTOBUF_INCLUDED_tensorflow_2fpython_2ftraining_2fcheckpoint_5fstate_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_tensorflow_2fpython_2ftraining_2fcheckpoint_5fstate_2eproto 
...
namespace google {
namespace protobuf {
template<> ::tensorflow::CheckpointState* Arena::CreateMaybeMessage<::tensorflow::CheckpointState>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
inline void CheckpointState::set_model_checkpoint_path(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:tensorflow.CheckpointState.model_checkpoint_path)
}
#endif
...
inline double CheckpointState::all_model_checkpoint_timestamps(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.CheckpointState.all_model_checkpoint_timestamps)
...
inline void CheckpointState::set_all_model_checkpoint_timestamps(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:tensorflow.CheckpointState.all_model_checkpoint_timestamps)
}
inline void CheckpointState::add_all_model_checkpoint_timestamps(double value) {
  all_model_checkpoint_timestamps_.Add(value);
  // @@protoc_insertion_point(field_add:tensorflow.CheckpointState.all_model_checkpoint_timestamps)
}
inline const ::google::protobuf::RepeatedField< double >&
CheckpointState::all_model_checkpoint_timestamps() const {
  // @@protoc_insertion_point(field_list:tensorflow.CheckpointState.all_model_checkpoint_timestamps)
  return all_model_checkpoint_timestamps_;
}
inline ::google::protobuf::RepeatedField< double >*
CheckpointState::mutable_all_model_checkpoint_timestamps() {
  // @@protoc_insertion_point(field_mutable_list:tensorflow.CheckpointState.all_model_checkpoint_timestamps)
  return &all_model_checkpoint_timestamps_;
}
...
inline double CheckpointState::last_preserved_timestamp() const {
  // @@protoc_insertion_point(field_get:tensorflow.CheckpointState.last_preserved_timestamp)
...
inline void CheckpointState::set_last_preserved_timestamp(double value) {
  ...
  // @@protoc_insertion_point(field_set:tensorflow.CheckpointState.last_preserved_timestamp)
}
...
#endif  // PROTOBUF_INCLUDED_tensorflow_2fpython_2ftraining_2fcheckpoint_5fstate_2eproto
