...
#ifndef PROTOBUF_INCLUDED_tensorflow_2fpython_2fkeras_2fprotobuf_2fversions_2eproto
#define PROTOBUF_INCLUDED_tensorflow_2fpython_2fkeras_2fprotobuf_2fversions_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_tensorflow_2fpython_2fkeras_2fprotobuf_2fversions_2eproto 
...
namespace google {
namespace protobuf {
template<> ::third_party::tensorflow::python::keras::protobuf::VersionDef* Arena::CreateMaybeMessage<::third_party::tensorflow::python::keras::protobuf::VersionDef>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace third_party {
namespace tensorflow {
...
class VersionDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:third_party.tensorflow.python.keras.protobuf.VersionDef) */ {
 public:
  VersionDef();
  virtual ~VersionDef();
 ...
 private:
  ...
  friend struct ::protobuf_tensorflow_2fpython_2fkeras_2fprotobuf_2fversions_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::protobuf::int32 VersionDef::producer() const {
  // @@protoc_insertion_point(field_get:third_party.tensorflow.python.keras.protobuf.VersionDef.producer)
  return producer_;
}
inline void VersionDef::set_producer(::google::protobuf::int32 value) {
  
  producer_ = value;
  // @@protoc_insertion_point(field_set:third_party.tensorflow.python.keras.protobuf.VersionDef.producer)
}
...
inline ::google::protobuf::int32 VersionDef::min_consumer() const {
  // @@protoc_insertion_point(field_get:third_party.tensorflow.python.keras.protobuf.VersionDef.min_consumer)
  return min_consumer_;
}
inline void VersionDef::set_min_consumer(::google::protobuf::int32 value) {
  
  min_consumer_ = value;
  // @@protoc_insertion_point(field_set:third_party.tensorflow.python.keras.protobuf.VersionDef.min_consumer)
}
...
inline ::google::protobuf::int32 VersionDef::bad_consumers(int index) const {
  // @@protoc_insertion_point(field_get:third_party.tensorflow.python.keras.protobuf.VersionDef.bad_consumers)
...
inline void VersionDef::set_bad_consumers(int index, ::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:third_party.tensorflow.python.keras.protobuf.VersionDef.bad_consumers)
}
inline void VersionDef::add_bad_consumers(::google::protobuf::int32 value) {
  bad_consumers_.Add(value);
  // @@protoc_insertion_point(field_add:third_party.tensorflow.python.keras.protobuf.VersionDef.bad_consumers)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
VersionDef::bad_consumers() const {
  // @@protoc_insertion_point(field_list:third_party.tensorflow.python.keras.protobuf.VersionDef.bad_consumers)
  return bad_consumers_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
VersionDef::mutable_bad_consumers() {
  // @@protoc_insertion_point(field_mutable_list:third_party.tensorflow.python.keras.protobuf.VersionDef.bad_consumers)
  return &bad_consumers_;
}
...
#endif  // PROTOBUF_INCLUDED_tensorflow_2fpython_2fkeras_2fprotobuf_2fversions_2eproto
