...
#ifndef PROTOBUF_INCLUDED_tensorflow_2fcore_2fprofiler_2fprotobuf_2fop_5fprofile_2eproto
#define PROTOBUF_INCLUDED_tensorflow_2fcore_2fprofiler_2fprotobuf_2fop_5fprofile_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_tensorflow_2fcore_2fprofiler_2fprotobuf_2fop_5fprofile_2eproto 
...
class Profile : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.profiler.op_profile.Profile) */ {
 public:
  ...
  bool has_by_category_exclude_idle() const;
  void clear_by_category_exclude_idle();
  static const int kByCategoryExcludeIdleFieldNumber = 6;
  private:
  const ::tensorflow::profiler::op_profile::Node& _internal_by_category_exclude_idle() const;
  public:
  const ::tensorflow::profiler::op_profile::Node& by_category_exclude_idle() const;
  ::tensorflow::profiler::op_profile::Node* release_by_category_exclude_idle();
  ::tensorflow::profiler::op_profile::Node* mutable_by_category_exclude_idle();
  void set_allocated_by_category_exclude_idle(::tensorflow::profiler::op_profile::Node* by_category_exclude_idle);

  // .tensorflow.profiler.op_profile.Node by_program_exclude_idle = 7;
  bool has_by_program_exclude_idle() const;
  void clear_by_program_exclude_idle();
  static const int kByProgramExcludeIdleFieldNumber = 7;
  private:
  const ::tensorflow::profiler::op_profile::Node& _internal_by_program_exclude_idle() const;
  public:
  const ::tensorflow::profiler::op_profile::Node& by_program_exclude_idle() const;
  ::tensorflow::profiler::op_profile::Node* release_by_program_exclude_idle();
  ::tensorflow::profiler::op_profile::Node* mutable_by_program_exclude_idle();
  void set_allocated_by_program_exclude_idle(::tensorflow::profiler::op_profile::Node* by_program_exclude_idle);
 ...
 private:
  ...
  ::tensorflow::profiler::op_profile::Node* by_category_exclude_idle_;
  ::tensorflow::profiler::op_profile::Node* by_program_exclude_idle_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fprofiler_2fprotobuf_2fop_5fprofile_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
// .tensorflow.profiler.op_profile.Node by_category_exclude_idle = 6;
inline bool Profile::has_by_category_exclude_idle() const {
  return this != internal_default_instance() && by_category_exclude_idle_ != NULL;
}
inline void Profile::clear_by_category_exclude_idle() {
  if (GetArenaNoVirtual() == NULL && by_category_exclude_idle_ != NULL) {
    delete by_category_exclude_idle_;
  }
  by_category_exclude_idle_ = NULL;
}
inline const ::tensorflow::profiler::op_profile::Node& Profile::_internal_by_category_exclude_idle() const {
  return *by_category_exclude_idle_;
}
inline const ::tensorflow::profiler::op_profile::Node& Profile::by_category_exclude_idle() const {
  const ::tensorflow::profiler::op_profile::Node* p = by_category_exclude_idle_;
  // @@protoc_insertion_point(field_get:tensorflow.profiler.op_profile.Profile.by_category_exclude_idle)
  return p != NULL ? *p : *reinterpret_cast<const ::tensorflow::profiler::op_profile::Node*>(
      &::tensorflow::profiler::op_profile::_Node_default_instance_);
}
inline ::tensorflow::profiler::op_profile::Node* Profile::release_by_category_exclude_idle() {
  // @@protoc_insertion_point(field_release:tensorflow.profiler.op_profile.Profile.by_category_exclude_idle)
  
  ::tensorflow::profiler::op_profile::Node* temp = by_category_exclude_idle_;
  by_category_exclude_idle_ = NULL;
  return temp;
}
inline ::tensorflow::profiler::op_profile::Node* Profile::mutable_by_category_exclude_idle() {
  
  if (by_category_exclude_idle_ == NULL) {
    auto* p = CreateMaybeMessage<::tensorflow::profiler::op_profile::Node>(GetArenaNoVirtual());
    by_category_exclude_idle_ = p;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.profiler.op_profile.Profile.by_category_exclude_idle)
  return by_category_exclude_idle_;
}
inline void Profile::set_allocated_by_category_exclude_idle(::tensorflow::profiler::op_profile::Node* by_category_exclude_idle) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete by_category_exclude_idle_;
  }
  if (by_category_exclude_idle) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      by_category_exclude_idle = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, by_category_exclude_idle, submessage_arena);
    }
    
  } else {
    
  }
  by_category_exclude_idle_ = by_category_exclude_idle;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.profiler.op_profile.Profile.by_category_exclude_idle)
}

// .tensorflow.profiler.op_profile.Node by_program_exclude_idle = 7;
inline bool Profile::has_by_program_exclude_idle() const {
  return this != internal_default_instance() && by_program_exclude_idle_ != NULL;
}
inline void Profile::clear_by_program_exclude_idle() {
  if (GetArenaNoVirtual() == NULL && by_program_exclude_idle_ != NULL) {
    delete by_program_exclude_idle_;
  }
  by_program_exclude_idle_ = NULL;
}
inline const ::tensorflow::profiler::op_profile::Node& Profile::_internal_by_program_exclude_idle() const {
  return *by_program_exclude_idle_;
}
inline const ::tensorflow::profiler::op_profile::Node& Profile::by_program_exclude_idle() const {
  const ::tensorflow::profiler::op_profile::Node* p = by_program_exclude_idle_;
  // @@protoc_insertion_point(field_get:tensorflow.profiler.op_profile.Profile.by_program_exclude_idle)
  return p != NULL ? *p : *reinterpret_cast<const ::tensorflow::profiler::op_profile::Node*>(
      &::tensorflow::profiler::op_profile::_Node_default_instance_);
}
inline ::tensorflow::profiler::op_profile::Node* Profile::release_by_program_exclude_idle() {
  // @@protoc_insertion_point(field_release:tensorflow.profiler.op_profile.Profile.by_program_exclude_idle)
  
  ::tensorflow::profiler::op_profile::Node* temp = by_program_exclude_idle_;
  by_program_exclude_idle_ = NULL;
  return temp;
}
inline ::tensorflow::profiler::op_profile::Node* Profile::mutable_by_program_exclude_idle() {
  
  if (by_program_exclude_idle_ == NULL) {
    auto* p = CreateMaybeMessage<::tensorflow::profiler::op_profile::Node>(GetArenaNoVirtual());
    by_program_exclude_idle_ = p;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.profiler.op_profile.Profile.by_program_exclude_idle)
  return by_program_exclude_idle_;
}
inline void Profile::set_allocated_by_program_exclude_idle(::tensorflow::profiler::op_profile::Node* by_program_exclude_idle) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete by_program_exclude_idle_;
  }
  if (by_program_exclude_idle) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      by_program_exclude_idle = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, by_program_exclude_idle, submessage_arena);
    }
    
  } else {
    
  }
  by_program_exclude_idle_ = by_program_exclude_idle;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.profiler.op_profile.Profile.by_program_exclude_idle)
}
...
#endif  // PROTOBUF_INCLUDED_tensorflow_2fcore_2fprofiler_2fprotobuf_2fop_5fprofile_2eproto
