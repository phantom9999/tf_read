...
#ifndef PROTOBUF_INCLUDED_tensorflow_2fcore_2fprofiler_2fprofiler_5fanalysis_2eproto
#define PROTOBUF_INCLUDED_tensorflow_2fcore_2fprofiler_2fprofiler_5fanalysis_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_tensorflow_2fcore_2fprofiler_2fprofiler_5fanalysis_2eproto 
...
class NewProfileSessionRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.NewProfileSessionRequest) */ {
 public:
 ...
 private:
  ...
  friend struct ::protobuf_tensorflow_2fcore_2fprofiler_2fprofiler_5fanalysis_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class NewProfileSessionResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.NewProfileSessionResponse) */ {
 public:
...
class EnumProfileSessionsAndToolsRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.EnumProfileSessionsAndToolsRequest) */ {
 public:
...
class ProfileSessionInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.ProfileSessionInfo) */ {
 public:
  ProfileSessionInfo();
...
class EnumProfileSessionsAndToolsResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.EnumProfileSessionsAndToolsResponse) */ {
 public:
  ...
  ::google::protobuf::RepeatedPtrField< ::tensorflow::ProfileSessionInfo >*
      mutable_sessions();
  const ::tensorflow::ProfileSessionInfo& sessions(int index) const;
  ::tensorflow::ProfileSessionInfo* add_sessions();
  const ::google::protobuf::RepeatedPtrField< ::tensorflow::ProfileSessionInfo >&
      sessions() const;
...
class ProfileSessionDataRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.ProfileSessionDataRequest) */ {
 public:
...
class ProfileSessionDataResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.ProfileSessionDataResponse) */ {
 public:
...
inline const ::tensorflow::ProfileRequest& NewProfileSessionRequest::request() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::tensorflow::ProfileRequest*>(
...
#endif  // PROTOBUF_INCLUDED_tensorflow_2fcore_2fprofiler_2fprofiler_5fanalysis_2eproto
