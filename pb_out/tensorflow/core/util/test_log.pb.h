...
class MetricEntry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.MetricEntry) */ {
 public:
  MetricEntry();
  virtual ~MetricEntry();
  ...
  inline MetricEntry* New() const final {
    return CreateMaybeMessage<MetricEntry>(NULL);
  }
