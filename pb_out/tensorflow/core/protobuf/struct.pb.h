...
class TypeSpecProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.TypeSpecProto) */ {
 public:
  ...
  inline TypeSpecProto* New() const final {
    return CreateMaybeMessage<TypeSpecProto>(NULL);
  }

  TypeSpecProto* New(::google::protobuf::Arena* arena) const final {
...
inline bool TypeSpecProto::has_type_state() const {
  return this != internal_default_instance() && type_state_ != NULL;
}
...
inline void TypeSpecProto::set_allocated_type_state(::tensorflow::StructuredValue* type_state) {
  ...
  if (type_state) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      type_state = ::google::protobuf::internal::GetOwnedMessage(
