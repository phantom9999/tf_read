...
class AutotuneResult_FailureResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.AutotuneResult.FailureResult) */ {
 public:
  ...
  inline AutotuneResult_FailureResult* New() const final {
    return CreateMaybeMessage<AutotuneResult_FailureResult>(NULL);
  }
...
class AutotuneResult_GemmKey : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.AutotuneResult.GemmKey) */ {
 public:
  ...
  inline AutotuneResult_GemmKey* New() const final {
    return CreateMaybeMessage<AutotuneResult_GemmKey>(NULL);
  }

  AutotuneResult_GemmKey* New(::google::protobuf::Arena* arena) const final {
...
inline const ::tensorflow::AutotuneResult_FailureResult& AutotuneResult::failure() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::tensorflow::AutotuneResult_FailureResult*>(
