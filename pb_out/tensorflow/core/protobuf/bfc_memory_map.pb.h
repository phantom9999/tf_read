...
#ifndef PROTOBUF_INCLUDED_tensorflow_2fcore_2fprotobuf_2fbfc_5fmemory_5fmap_2eproto
#define PROTOBUF_INCLUDED_tensorflow_2fcore_2fprotobuf_2fbfc_5fmemory_5fmap_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_tensorflow_2fcore_2fprotobuf_2fbfc_5fmemory_5fmap_2eproto 
...
class MemAllocatorStats : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.MemAllocatorStats) */ {
 public:
  ...
  inline MemAllocatorStats* New() const final {
    return CreateMaybeMessage<MemAllocatorStats>(NULL);
  }

  MemAllocatorStats* New(::google::protobuf::Arena* arena) const final {
 ...
 private:
  ...
  friend struct ::protobuf_tensorflow_2fcore_2fprotobuf_2fbfc_5fmemory_5fmap_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class MemChunk : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.MemChunk) */ {
 public:
  ...
  inline MemChunk* New() const final {
    return CreateMaybeMessage<MemChunk>(NULL);
  }

  MemChunk* New(::google::protobuf::Arena* arena) const final {
...
class BinSummary : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.BinSummary) */ {
 public:
  ...
  inline BinSummary* New() const final {
    return CreateMaybeMessage<BinSummary>(NULL);
  }

  BinSummary* New(::google::protobuf::Arena* arena) const final {
...
class MemoryDump : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.MemoryDump) */ {
 public:
  ...
  inline MemoryDump* New() const final {
    return CreateMaybeMessage<MemoryDump>(NULL);
  }

  MemoryDump* New(::google::protobuf::Arena* arena) const final {
...
inline const ::tensorflow::MemAllocatorStats& MemoryDump::stats() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::tensorflow::MemAllocatorStats*>(
...
#endif  // PROTOBUF_INCLUDED_tensorflow_2fcore_2fprotobuf_2fbfc_5fmemory_5fmap_2eproto
