...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "tensorflow/core/protobuf/error_codes.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ::google::protobuf::EnumDescriptor* Code_descriptor() {
  protobuf_tensorflow_2fcore_2fprotobuf_2ferror_5fcodes_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorflow_2fcore_2fprotobuf_2ferror_5fcodes_2eproto::file_level_enum_descriptors[0];
}
