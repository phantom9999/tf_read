...
#ifndef PROTOBUF_INCLUDED_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto
#define PROTOBUF_INCLUDED_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto 
...
enum CardinalityOptions_ComputeLevel {
  ...
  CardinalityOptions_ComputeLevel_CardinalityOptions_ComputeLevel_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  CardinalityOptions_ComputeLevel_CardinalityOptions_ComputeLevel_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool CardinalityOptions_ComputeLevel_IsValid(int value);
const CardinalityOptions_ComputeLevel CardinalityOptions_ComputeLevel_ComputeLevel_MIN = CardinalityOptions_ComputeLevel_CARDINALITY_COMPUTE_UNSPECIFIED;
const CardinalityOptions_ComputeLevel CardinalityOptions_ComputeLevel_ComputeLevel_MAX = CardinalityOptions_ComputeLevel_CARDINALITY_COMPUTE_MODERATE;
const int CardinalityOptions_ComputeLevel_ComputeLevel_ARRAYSIZE = CardinalityOptions_ComputeLevel_ComputeLevel_MAX + 1;
...
inline const ::std::string& CardinalityOptions_ComputeLevel_Name(CardinalityOptions_ComputeLevel value) {
  return ::google::protobuf::internal::NameOfEnum(
    CardinalityOptions_ComputeLevel_descriptor(), value);
}
...
enum AutoShardPolicy {
  ...
  HINT = 3,
  OFF = -1,
  AutoShardPolicy_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  AutoShardPolicy_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool AutoShardPolicy_IsValid(int value);
const AutoShardPolicy AutoShardPolicy_MIN = OFF;
const AutoShardPolicy AutoShardPolicy_MAX = HINT;
const int AutoShardPolicy_ARRAYSIZE = AutoShardPolicy_MAX + 1;
...
inline const ::std::string& AutoShardPolicy_Name(AutoShardPolicy value) {
  return ::google::protobuf::internal::NameOfEnum(
    AutoShardPolicy_descriptor(), value);
}
...
enum ExternalStatePolicy {
  ...
  POLICY_IGNORE = 1,
  POLICY_FAIL = 2,
  ExternalStatePolicy_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ExternalStatePolicy_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool ExternalStatePolicy_IsValid(int value);
const ExternalStatePolicy ExternalStatePolicy_MIN = POLICY_WARN;
const ExternalStatePolicy ExternalStatePolicy_MAX = POLICY_FAIL;
const int ExternalStatePolicy_ARRAYSIZE = ExternalStatePolicy_MAX + 1;
...
inline const ::std::string& ExternalStatePolicy_Name(ExternalStatePolicy value) {
  return ::google::protobuf::internal::NameOfEnum(
    ExternalStatePolicy_descriptor(), value);
}
...
class AutotuneOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.data.AutotuneOptions) */ {
 public:
  AutotuneOptions();
  ...
  void Swap(AutotuneOptions* other);
  ...
  inline AutotuneOptions* New() const final {
    return CreateMaybeMessage<AutotuneOptions>(NULL);
  }

  AutotuneOptions* New(::google::protobuf::Arena* arena) const final {
  ...
  ::google::protobuf::int32 cpu_budget() const;
  void set_cpu_budget(::google::protobuf::int32 value);
  ...
  static const int kAutotuneAlgorithmFieldNumber = 4;
 ...
 private:
  ...
  friend struct ::protobuf_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class CardinalityOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.data.CardinalityOptions) */ {
 public:
  CardinalityOptions();
  ...
  void Swap(CardinalityOptions* other);
  ...
  inline CardinalityOptions* New() const final {
    return CreateMaybeMessage<CardinalityOptions>(NULL);
  }

  CardinalityOptions* New(::google::protobuf::Arena* arena) const final {
  ...
  static const ComputeLevel CARDINALITY_COMPUTE_UNSPECIFIED =
    CardinalityOptions_ComputeLevel_CARDINALITY_COMPUTE_UNSPECIFIED;
  static const ComputeLevel CARDINALITY_COMPUTE_LOW =
    CardinalityOptions_ComputeLevel_CARDINALITY_COMPUTE_LOW;
  static const ComputeLevel CARDINALITY_COMPUTE_MODERATE =
  ...
  static const ComputeLevel ComputeLevel_MIN =
    CardinalityOptions_ComputeLevel_ComputeLevel_MIN;
  static const ComputeLevel ComputeLevel_MAX =
    CardinalityOptions_ComputeLevel_ComputeLevel_MAX;
  static const int ComputeLevel_ARRAYSIZE =
  ...
  static inline const ::std::string& ComputeLevel_Name(ComputeLevel value) {
  ...
  static const int kComputeLevelFieldNumber = 1;
...
class DistributeOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.data.DistributeOptions) */ {
 public:
  DistributeOptions();
  ...
  void Swap(DistributeOptions* other);
  ...
  inline DistributeOptions* New() const final {
    return CreateMaybeMessage<DistributeOptions>(NULL);
  }

  DistributeOptions* New(::google::protobuf::Arena* arena) const final {
  ...
  static const int kAutoShardPolicyFieldNumber = 1;
  ...
  static const int kNumDevicesFieldNumber = 2;
  ::google::protobuf::int32 num_devices() const;
  void set_num_devices(::google::protobuf::int32 value);
...
class OptimizationOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.data.OptimizationOptions) */ {
 public:
  OptimizationOptions();
  ...
  void Swap(OptimizationOptions* other);
  ...
  inline OptimizationOptions* New() const final {
    return CreateMaybeMessage<OptimizationOptions>(NULL);
  }

  OptimizationOptions* New(::google::protobuf::Arena* arena) const final {
  ...
  static const int kApplyDefaultOptimizationsFieldNumber = 1;
  ...
  static const int kFilterFusionFieldNumber = 6;
  ...
  static const int kMapAndBatchFusionFieldNumber = 9;
  ...
  static const int kMapAndFilterFusionFieldNumber = 10;
  ...
  static const int kMapFusionFieldNumber = 11;
  ...
  static const int kMapParallelizationFieldNumber = 12;
  ...
  static const int kNoopEliminationFieldNumber = 14;
  ...
  static const int kParallelBatchFieldNumber = 15;
  ...
  static const int kShuffleAndRepeatFusionFieldNumber = 17;
  ...
  static const int kFilterParallelizationFieldNumber = 18;
...
class ThreadingOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.data.ThreadingOptions) */ {
 public:
  ThreadingOptions();
  ...
  void Swap(ThreadingOptions* other);
  ...
  inline ThreadingOptions* New() const final {
    return CreateMaybeMessage<ThreadingOptions>(NULL);
  }

  ThreadingOptions* New(::google::protobuf::Arena* arena) const final {
  ...
  static const int kMaxIntraOpParallelismFieldNumber = 1;
  ::google::protobuf::int32 max_intra_op_parallelism() const;
  void set_max_intra_op_parallelism(::google::protobuf::int32 value);
  ...
  static const int kPrivateThreadpoolSizeFieldNumber = 2;
  ::google::protobuf::int32 private_threadpool_size() const;
  void set_private_threadpool_size(::google::protobuf::int32 value);
...
class Options : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.data.Options) */ {
 public:
  Options();
  virtual ~Options();
  ...
  static const int kDistributeOptionsFieldNumber = 2;
  private:
  ...
  static const int kOptimizationOptionsFieldNumber = 3;
  private:
  ...
  static const int kThreadingOptionsFieldNumber = 5;
  private:
  ...
  static const int kAutotuneOptionsFieldNumber = 7;
  private:
  ...
  static const int kDeterministicFieldNumber = 1;
  ...
  static const int kExternalStatePolicyFieldNumber = 6;
...
inline ::google::protobuf::int32 AutotuneOptions::cpu_budget() const {
...
inline void AutotuneOptions::set_cpu_budget(::google::protobuf::int32 value) {
  if (!has_cpu_budget()) {
...
inline void AutotuneOptions::clear_ram_budget() {
  if (has_ram_budget()) {
    optional_ram_budget_.ram_budget_ = GOOGLE_LONGLONG(0);
    clear_has_optional_ram_budget();
  }
}
inline ::google::protobuf::int64 AutotuneOptions::ram_budget() const {
...
inline void AutotuneOptions::set_ram_budget(::google::protobuf::int64 value) {
  if (!has_ram_budget()) {
...
inline ::google::protobuf::int32 DistributeOptions::num_devices() const {
...
inline void DistributeOptions::set_num_devices(::google::protobuf::int32 value) {
  if (!has_num_devices()) {
...
inline ::google::protobuf::int32 ThreadingOptions::max_intra_op_parallelism() const {
...
inline void ThreadingOptions::set_max_intra_op_parallelism(::google::protobuf::int32 value) {
  if (!has_max_intra_op_parallelism()) {
...
inline ::google::protobuf::int32 ThreadingOptions::private_threadpool_size() const {
...
inline void ThreadingOptions::set_private_threadpool_size(::google::protobuf::int32 value) {
  if (!has_private_threadpool_size()) {
...
inline bool Options::has_autotune_options() const {
  return this != internal_default_instance() && autotune_options_ != NULL;
}
...
inline const ::tensorflow::data::AutotuneOptions& Options::autotune_options() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::tensorflow::data::AutotuneOptions*>(
...
inline void Options::set_allocated_autotune_options(::tensorflow::data::AutotuneOptions* autotune_options) {
  ...
  if (autotune_options) {
    ...
    if (message_arena != submessage_arena) {
      autotune_options = ::google::protobuf::internal::GetOwnedMessage(
...
inline bool Options::has_distribute_options() const {
  return this != internal_default_instance() && distribute_options_ != NULL;
}
...
inline const ::tensorflow::data::DistributeOptions& Options::distribute_options() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::tensorflow::data::DistributeOptions*>(
...
inline void Options::set_allocated_distribute_options(::tensorflow::data::DistributeOptions* distribute_options) {
  ...
  if (distribute_options) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      distribute_options = ::google::protobuf::internal::GetOwnedMessage(
...
inline bool Options::has_optimization_options() const {
  return this != internal_default_instance() && optimization_options_ != NULL;
}
...
inline const ::tensorflow::data::OptimizationOptions& Options::optimization_options() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::tensorflow::data::OptimizationOptions*>(
...
inline void Options::set_allocated_optimization_options(::tensorflow::data::OptimizationOptions* optimization_options) {
  ...
  if (optimization_options) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      optimization_options = ::google::protobuf::internal::GetOwnedMessage(
...
inline bool Options::has_threading_options() const {
  return this != internal_default_instance() && threading_options_ != NULL;
}
...
inline const ::tensorflow::data::ThreadingOptions& Options::threading_options() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::tensorflow::data::ThreadingOptions*>(
...
inline void Options::set_allocated_threading_options(::tensorflow::data::ThreadingOptions* threading_options) {
  ...
  if (threading_options) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      threading_options = ::google::protobuf::internal::GetOwnedMessage(
...
#endif  // PROTOBUF_INCLUDED_tensorflow_2fcore_2fframework_2fdataset_5foptions_2eproto
