...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::VariableDef, synchronization_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::VariableDef, aggregation_),
  ~0u,  // no _has_bits_
...
const ::google::protobuf::EnumDescriptor* VariableSynchronization_descriptor() {
  ...
  return protobuf_tensorflow_2fcore_2fframework_2fvariable_2eproto::file_level_enum_descriptors[0];
}
...
const ::google::protobuf::EnumDescriptor* VariableAggregation_descriptor() {
  protobuf_tensorflow_2fcore_2fframework_2fvariable_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorflow_2fcore_2fframework_2fvariable_2eproto::file_level_enum_descriptors[1];
}
