...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "tensorflow_serving/apis/status.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "tensorflow_serving/apis/status.proto", &protobuf_RegisterTypes);
...
StatusProto::StatusProto(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_tensorflow_5fserving_2fapis_2fstatus_2eproto::scc_info_StatusProto.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* StatusProto::descriptor() {
  ::protobuf_tensorflow_5fserving_2fapis_2fstatus_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_tensorflow_5fserving_2fapis_2fstatus_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata StatusProto::GetMetadata() const {
  protobuf_tensorflow_5fserving_2fapis_2fstatus_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_tensorflow_5fserving_2fapis_2fstatus_2eproto::file_level_metadata[kIndexInFileMessages];
}
