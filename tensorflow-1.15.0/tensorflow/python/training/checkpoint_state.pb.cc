...
static void InitDefaultsCheckpointState() {
  ...
  {
    void* ptr = &::tensorflow::_CheckpointState_default_instance_;
    new (ptr) ::tensorflow::CheckpointState();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::tensorflow::CheckpointState::InitAsDefaultInstance();
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::CheckpointState, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::CheckpointState, model_checkpoint_path_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::CheckpointState, all_model_checkpoint_paths_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::CheckpointState, all_model_checkpoint_timestamps_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::CheckpointState, last_preserved_timestamp_),
};
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::tensorflow::CheckpointState)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::tensorflow::_CheckpointState_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "tensorflow/python/training/checkpoint_state.proto", schemas, file_default_instances, TableStruct::offsets,
...
CheckpointState::CheckpointState()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_tensorflow_2fpython_2ftraining_2fcheckpoint_5fstate_2eproto::scc_info_CheckpointState.base);
  SharedCtor();
...
CheckpointState::CheckpointState(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_tensorflow_2fpython_2ftraining_2fcheckpoint_5fstate_2eproto::scc_info_CheckpointState.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* CheckpointState::descriptor() {
  ...
  return ::protobuf_tensorflow_2fpython_2ftraining_2fcheckpoint_5fstate_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata CheckpointState::GetMetadata() const {
  protobuf_tensorflow_2fpython_2ftraining_2fcheckpoint_5fstate_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_tensorflow_2fpython_2ftraining_2fcheckpoint_5fstate_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::CheckpointState* Arena::CreateMaybeMessage< ::tensorflow::CheckpointState >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::CheckpointState >(arena);
}
}  // namespace protobuf
}  // namespace google
