...
class LearnerConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.LearnerConfig) */ {
 public:
  ...
  private:
  const ::tensorflow::boosted_trees::trees::DecisionTreeConfig& _internal_each_tree_start() const;
  public:
  ...
  ::google::protobuf::int32 each_tree_start_num_layers() const;
  void set_each_tree_start_num_layers(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::google::protobuf::int32 each_tree_start_num_layers_;
...
inline bool LearnerConfig::has_each_tree_start() const {
  return this != internal_default_instance() && each_tree_start_ != NULL;
}
inline const ::tensorflow::boosted_trees::trees::DecisionTreeConfig& LearnerConfig::_internal_each_tree_start() const {
...
inline const ::tensorflow::boosted_trees::trees::DecisionTreeConfig& LearnerConfig::each_tree_start() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::tensorflow::boosted_trees::trees::DecisionTreeConfig*>(
...
inline void LearnerConfig::set_allocated_each_tree_start(::tensorflow::boosted_trees::trees::DecisionTreeConfig* each_tree_start) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(each_tree_start_);
  }
  if (each_tree_start) {
    ::google::protobuf::Arena* submessage_arena =
      reinterpret_cast<::google::protobuf::MessageLite*>(each_tree_start)->GetArena();
    if (message_arena != submessage_arena) {
      each_tree_start = ::google::protobuf::internal::GetOwnedMessage(
...
inline ::google::protobuf::int32 LearnerConfig::each_tree_start_num_layers() const {
...
inline void LearnerConfig::set_each_tree_start_num_layers(::google::protobuf::int32 value) {
