...
#ifndef PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fgdr_2fgdr_2eproto
#define PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fgdr_2fgdr_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_tensorflow_2fcontrib_2fgdr_2fgdr_2eproto 
...
namespace google {
namespace protobuf {
template<> ::tensorflow::RemoteMemoryRegion* Arena::CreateMaybeMessage<::tensorflow::RemoteMemoryRegion>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class RemoteMemoryRegion : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.RemoteMemoryRegion) */ {
 public:
  ...
  inline RemoteMemoryRegion* New() const final {
    return CreateMaybeMessage<RemoteMemoryRegion>(NULL);
  }

  RemoteMemoryRegion* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<RemoteMemoryRegion>(arena);
  }
...
#endif  // PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fgdr_2fgdr_2eproto
