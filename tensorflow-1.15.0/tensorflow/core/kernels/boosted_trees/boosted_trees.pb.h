...
enum SplitTypeWithDefault {
  ...
  SplitTypeWithDefault_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  SplitTypeWithDefault_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool SplitTypeWithDefault_IsValid(int value);
const SplitTypeWithDefault SplitTypeWithDefault_MIN = INEQUALITY_DEFAULT_LEFT;
const SplitTypeWithDefault SplitTypeWithDefault_MAX = EQUALITY_DEFAULT_RIGHT;
const int SplitTypeWithDefault_ARRAYSIZE = SplitTypeWithDefault_MAX + 1;

const ::google::protobuf::EnumDescriptor* SplitTypeWithDefault_descriptor();
inline const ::std::string& SplitTypeWithDefault_Name(SplitTypeWithDefault value) {
  return ::google::protobuf::internal::NameOfEnum(
    SplitTypeWithDefault_descriptor(), value);
}
inline bool SplitTypeWithDefault_Parse(
    const ::std::string& name, SplitTypeWithDefault* value) {
  return ::google::protobuf::internal::ParseNamedEnum<SplitTypeWithDefault>(
    SplitTypeWithDefault_descriptor(), name, value);
}
enum DefaultDirection {
  DEFAULT_LEFT = 0,
  DEFAULT_RIGHT = 1,
  DefaultDirection_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  DefaultDirection_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool DefaultDirection_IsValid(int value);
const DefaultDirection DefaultDirection_MIN = DEFAULT_LEFT;
const DefaultDirection DefaultDirection_MAX = DEFAULT_RIGHT;
const int DefaultDirection_ARRAYSIZE = DefaultDirection_MAX + 1;

const ::google::protobuf::EnumDescriptor* DefaultDirection_descriptor();
inline const ::std::string& DefaultDirection_Name(DefaultDirection value) {
  return ::google::protobuf::internal::NameOfEnum(
    DefaultDirection_descriptor(), value);
}
inline bool DefaultDirection_Parse(
    const ::std::string& name, DefaultDirection* value) {
  return ::google::protobuf::internal::ParseNamedEnum<DefaultDirection>(
...
class TreeMetadata_PostPruneNodeUpdate : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.TreeMetadata.PostPruneNodeUpdate) */ {
 ...
 private:
  ...
  mutable int _logit_change_cached_byte_size_;
...
inline ::google::protobuf::int32 CategoricalSplit::dimension_id() const {
  // @@protoc_insertion_point(field_get:tensorflow.boosted_trees.CategoricalSplit.dimension_id)
  return dimension_id_;
}
inline void CategoricalSplit::set_dimension_id(::google::protobuf::int32 value) {
