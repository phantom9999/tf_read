...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::NodeDef_ExperimentalDebugInfo, original_func_names_),
  ~0u,  // no _has_bits_
...
// @@protoc_insertion_point(message_byte_size_start:tensorflow.NodeDef.ExperimentalDebugInfo)
  ...
  // repeated string original_func_names = 2;
  total_size += 1 *
      ::google::protobuf::internal::FromIntSize(this->original_func_names_size());
  for (int i = 0, n = this->original_func_names_size(); i < n; i++) {
    total_size += ::google::protobuf::internal::WireFormatLite::StringSize(
