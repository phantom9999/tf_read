...
static void InitDefaultsCompilationResultProto() {
  ...
  {
    void* ptr = &::tensorflow::tpu::_CompilationResultProto_default_instance_;
    new (ptr) ::tensorflow::tpu::CompilationResultProto();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::tensorflow::tpu::CompilationResultProto::InitAsDefaultInstance();
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::tpu::CompilationResultProto, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::tensorflow::tpu::_CompilationResultProto_default_instance_),
};
...
CompilationResultProto::CompilationResultProto()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_tensorflow_2fcore_2fprotobuf_2ftpu_2fcompilation_5fresult_2eproto::scc_info_CompilationResultProto.base);
  SharedCtor();
...
CompilationResultProto::CompilationResultProto(::google::protobuf::Arena* arena)
  ...
  hlo_protos_(arena) {
  ::google::protobuf::internal::InitSCC(&protobuf_tensorflow_2fcore_2fprotobuf_2ftpu_2fcompilation_5fresult_2eproto::scc_info_CompilationResultProto.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* CompilationResultProto::descriptor() {
  ...
  return ::protobuf_tensorflow_2fcore_2fprotobuf_2ftpu_2fcompilation_5fresult_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata CompilationResultProto::GetMetadata() const {
  protobuf_tensorflow_2fcore_2fprotobuf_2ftpu_2fcompilation_5fresult_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_tensorflow_2fcore_2fprotobuf_2ftpu_2fcompilation_5fresult_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tpu::CompilationResultProto* Arena::CreateMaybeMessage< ::tensorflow::tpu::CompilationResultProto >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::tpu::CompilationResultProto >(arena);
}
}  // namespace protobuf
}  // namespace google
